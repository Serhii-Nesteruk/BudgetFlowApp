...
public class Budget
{
    ...
    [Required, Column("total_limit")] public decimal TotalLimit { get; set; }
    ...
    [Required, Column("telegram_enabled")] public bool TelegramEnabled { get; set; }
    ...
    [Required, Column("sharing_enabled")] public bool SharingEnabled { get; set; }
