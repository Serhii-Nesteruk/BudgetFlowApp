...
const STATUS_LABELS = { unpaid: "Не оплачено", overdue: "Прострочено", partial: "Частково", paid: "Оплачено" };
...
export default function DebtModal({ open, debt, onSave, onClose }) {
  ...
  function validate() {
    const e = {};
    if (!form.creditor.trim()) e.creditor = "Вкажіть кредитора";
    ...
    <div className={styles.overlay} onClick={e => e.target === e.currentTarget && onClose()}>
      <div className={styles.modal}>
        <div className={styles.header}>
          <h2 className={styles.title}>{debt ? "Редагувати борг" : "Новий борг"}</h2>
          ...
          <div className={styles.cols2}>
            ...
            <div className={styles.row}>
              <label className={styles.label}>
                {form.type === "installment" ? "Дата першого платежу *" : "Термін оплати *"}
              </label>
              <input
          ...
          <div className={styles.row}>
            ...
            <div className={styles.priorityRow}>
              ...
              <span className={styles.priHint}>
                {form.priority <= 2 ? "Низький" : form.priority === 3 ? "Середній" : form.priority === 4 ? "Високий" : "Критичний"}
              </span>
            </div>
          </div>
