...
const IconBudget = () => (
  ...
  >
    ...
    <path d="M4 6h13" />
    <path d="M15 12h5" />
    <circle cx="16.5" cy="12" r=".65" fill="currentColor" stroke="none" />
  </svg>
);
const IconSavings = () => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M5 8.5A4.5 4.5 0 0 1 9.5 4h5A4.5 4.5 0 0 1 19 8.5V18a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2z" />
    <path d="M8 4V2M16 4V2M9 12h6M12 9v6" />
  </svg>
);
const IconSettings = () => (
  <svg
...
export default function BottomNav({ activeTab, onTabChange, onScanReceipt, onAdd }) {
  ...
  const moreActive = activeTab === "budget" || activeTab === "savings" || activeTab === "settings";
        ...
        <section className={styles.moreSheet} aria-label="Додаткові розділи">
          ...
          <div className={styles.moreGrid}>
            ...
            <MoreItem
              icon={<IconSavings />}
              title="Накопичення"
              description="Банки, цілі та історія внесків"
...
function MoreItem({ icon, title, description, active, onClick }) {
  return (
    ...
    >
      ...
      <span className={styles.moreItemArrow}>
        <IconChevron />
      </span>
    </button>
  );
